...
odoPos.readData('~/npi/data/20131022_asguard_motocross_field/20131022-1812/20131207-1929/data/odometry_position.0.data', cov=True)
odoPos.eigenValues()

# Odometry Pose
pureodoPos = data.ThreeData()
pureodoPos.readData('~/npi/data/20131022_asguard_motocross_field/20131022-1812/20131207-2007/data/odometry_position.0.data', cov=True)
pureodoPos.eigenValues()

# Skid Odometry Pose
skidodoPos = data.ThreeData()
skidodoPos.readData('~/npi/data/20131022_asguard_motocross_field/20131022-1812/20131207-1929/data/skid_odometry_position.0.data', cov=True)
skidodoPos.eigenValues()

# GPS/Vicon reference from Ground Truth
refPos = data.ThreeData()
refPos.readData('~/npi/data/20131022_asguard_motocross_field/20131022-1812/20131207-1929/data/reference_position.0.data', cov=False)
refPos.eigenValues()
...
savefig('motocross_position_x_y.pdf')
...
savefig('motocross_position_x_z.pdf')
...
savefig('motocross_position_3d.pdf')
