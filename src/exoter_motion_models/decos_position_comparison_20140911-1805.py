...
path = '/home/javi/exoter/development/data/20140911_decos_field/20140911-1805_odometry_comparison/'
#######################################
...
#################################################
misalignment = odometry_orient.data[2528] * (~reference_orient.data[2528]) #~ is invert operator
...
#misalignment = quat.quaternion(np.array([0.0,1.0,0.0,0.0]))
...
#misalignment = quat.quaternion(np.array([0.0,0.0,1.0,0.0]))
#position[:] = [(misalignment * x * misalignment)[1:4] for x in position ]
