...
icp_odometry_file = '/home/jhidalgocarrio/exoter/development/post-process_data/20141024_planetary_lab/20141025-0005/pose_icpodo_position.0.data'
...
#Visual Odometry
icp_odo = data.ThreeData()
icp_odo.readData(icp_odometry_file, cov=False)
icp_odo.eigenValues()
...
xposition = icp_odo.getAxis(0)[0::2]
yposition = icp_odo.getAxis(1)[0::2]
ax.plot(xposition, yposition, marker='x', linestyle='--', label="ICP Odometry", color=[0,0.5,1], lw=2)
...
xposition = icp_odo.getAxis(0)[0::1]
yposition = icp_odo.getAxis(1)[0::1]
zposition = icp_odo.getAxis(2)[0::1]
