...
#Reference Velocity comparison X-Time
matplotlib.rcParams.update({'font.size': 30, 'font.weight': 'bold'})
fig = plt.figure(1)
ax = fig.add_subplot(111)
...
ax.plot(xtime, xvelocity, marker='o', linestyle='-.', label="CumSum Odometry", color=[0,0.5,1.0], lw=2)
...
#Reference Velocity comparison Z-Time
matplotlib.rcParams.update({'font.size': 30, 'font.weight': 'bold'})
fig = plt.figure(1)
ax = fig.add_subplot(111)
...
ax.plot(ytime, yvelocity, marker='o', linestyle='-.', label="CumSum Odometry", color=[0,0.5,1.0], lw=2)
...
ax.plot(ztime, zvelocity, marker='o', linestyle='-.', label="CumSum Odometry", color=[0,0.5,1.0], lw=2)
