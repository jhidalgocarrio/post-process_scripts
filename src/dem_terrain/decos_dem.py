...
decos_dem_file = '/home/javi/exoter/development/decos_terrain/decos_testing_area_point_cloud.ply'
#######################################
...
CS = plt.contour(xi, yi, zi, 150, linewidths=0.5, colors='k')
CS = plt.contourf(xi, yi, zi, 150, cmap=plt.cm.gray, vmax=abs(zi).max(), vmin=-abs(zi).max())
