...
def adaptive_matches_comparison_figure(fig_num, info_one, info_two, info_five,
    ...
    #h_cbar.ax.tick_params('y', colors='k')
...
##########################################################################
path='~/npi/data/20150515_planetary_lab/20150515-1752_orb_slam2_quadratic_adaptivity_one/'
...
path='~/npi/data/20150515_planetary_lab/20150515-1752_orb_slam2_quadratic_adaptivity_two/'
path_task_info_adaptive_slam_file = path + 'task_info_adaptive_slam.0.data'
...
path='~/npi/data/20150515_planetary_lab/20150515-1752_orb_slam2_quadratic_adaptivity_ten/'
path_task_info_adaptive_slam_file = path + 'task_info_adaptive_slam.0.data'
