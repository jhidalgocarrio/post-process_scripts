...
#spamReader = csv.reader(open('/home/jhidalgocarrio/esa-npi/dev/bundles/asguard/logs/20131115-1112/data/sensor_processing_imu_gyro.0.data', 'rb'), delimiter=' ', quotechar='|')
spamReader = csv.reader(open('/home/jhidalgocarrio/esa-npi/dev/bundles/asguard/logs/20131115-1548/data/sensor_processing_imu_gyro.0.data', 'rb'), delimiter=' ', quotechar='|')
spamReader = csv.reader(open('/home/jhidalgocarrio/esa-npi/dev/bundles/asguard/logs/20131115-1608/data/sensor_processing_imu_gyro.0.data', 'rb'), delimiter=' ', quotechar='|')
spamReader = csv.reader(open('/home/jhidalgocarrio/esa-npi/dev/bundles/asguard/logs/20131115-1645/data/sensor_processing_imu_gyro.0.data', 'rb'), delimiter=' ', quotechar='|')
spamReader = csv.reader(open('/home/jhidalgocarrio/esa-npi/experiments/20131022_motocross_field/20131022-1812/data/stim300_gyro.0.data', 'rb'), delimiter=' ', quotechar='|')
#spamReader = csv.reader(open('/home/jhidalgocarrio/esa-npi/dev/bundles/asguard/logs/20131115-1112/data/stim300_imu_gyro.0.data', 'rb'), delimiter=' ', quotechar='|')
...
plt.figure(4)
plot(t,gyrox, label="X axis", color='red')
...
roll[:] = [x * 180.00/math.pi for x in roll ]#convert to degrees
pitch[:] = [x * 180.00/math.pi for x in pitch ]#convert to degrees
yaw[:] = [x * 180.00/math.pi for x in yaw ]#convert to degrees

plot(t, roll, label="X axis", color='red')
plot(t, pitch, label="Y axis", color='green')
plot(t, yaw, label="Z axis", color='blue')
plt.show(block=False)
