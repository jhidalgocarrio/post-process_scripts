...
plt.plot(xposition, zposition, marker='D', linestyle='--', label="RTK GPS", color=[0.5,0,0], alpha=0.5, lw=2)
...
ax.plot(xposition, yposition, zposition, marker='D', label="RTK GPS", color=[0.5,0,0], alpha=0.5, lw=2)
